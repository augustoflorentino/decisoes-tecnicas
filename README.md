...
Registro de decisoes tecnicas e analises de trade-offs.
...
- [integracao-erp](projects/integracao-erp/) - Conectores SAP, TOTVS, Sankhya

## Templates

- [ADR - Architecture Decision Record](templates/adr.md)
- [Trade-off Analysis](templates/tradeoff.md)
